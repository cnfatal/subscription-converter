...
help:
	...
	@echo "  launchd-install       Install and start the user LaunchAgent"
	@echo "  launchd-sync-config   Copy CONFIG and restart the LaunchAgent"
...
launchd-install: build
	...
	@mkdir -p "$(SERVICE_DIR)" "$(LAUNCH_AGENTS_DIR)"
